            ...
            <table class="table align-items-center mb-0 display table-bordered " id="table_id">
                <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" rowspan="2">Daya (VA)</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" rowspan="2">Tanggal Periksa</th>
